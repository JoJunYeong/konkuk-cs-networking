...
window.NETWORKING_SITE_CONFIG = {
  ...
  form: {
    fields: [
      ...
      },
      {
        ...
        label: "참가 구분",
        type: "select",
        options: [{ value: "student", label: "재학생" }, { value: "graduate", label: "졸업생" }],
        required: true,
        width: "half",
      },
      {
    ...
    privacySummary:
      "수집 항목: 이름·휴대전화·참가 구분·입금자명. 신청 확인·입금 대조·취소 및 행사 운영에만 사용하며 행사 종료 90일 뒤 파기합니다.",
  },
  ...
  events: [
    ...
    },
    {
      ...
      venue: "홍대입구 인근",
      address: "",
      priceLabel: "재학생 5,000원 · 졸업생 10,000원",
      capacity: 100,
